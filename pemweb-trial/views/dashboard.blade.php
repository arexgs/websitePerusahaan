...
<div class="main-content">
  ...
  <header id="topbar">
    ...
    <div class="topbar-right">
      ...
      <div class="avatar-btn" id="topbarAvatar">--</div>
    </div>
  </header>
        ...
        <div class="ui-card mb-3">
          ...
          <div class="ui-card mb-3">
              ...
              <div class="d-flex align-items-center gap-4">
                  ...
                  <!-- Crop area -->
<div id="crop-container" style="display:none;margin-top:12px">
    <p style="font-size:12px;color:var(--muted);margin-bottom:8px">Sesuaikan posisi logo:</p>
    <div style="position:relative;width:200px;height:200px;overflow:hidden;border-radius:12px;border:2px solid var(--border);margin-bottom:8px">
        <img id="crop-img" style="position:absolute;cursor:move;max-width:none" draggable="false">
    </div>
    <div class="d-flex gap-2 align-items-center mb-2">
        <span style="font-size:12px">Zoom:</span>
        <input type="range" id="crop-zoom" min="100" max="300" value="100" style="flex:1" oninput="handleCropZoom(this.value)">
    </div>

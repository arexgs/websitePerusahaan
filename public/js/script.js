...
if (companyBtn && adminBtn) {
    // Set awal halaman saat pertama kali dibuka
    setMode('company');
    
    // ============================================================
    // FIX: Pasang listener klik agar currentMode bisa berubah dinamis!
    // ============================================================
    ...
    try {
        const response = await fetch('http://127.0.0.1:8000/api/login', {
            ...
            headers: {
                ...
                // === TAMBAHKAN BARIS INI UNTUK MENYEMBUHKAN CSRF ERROR ===
